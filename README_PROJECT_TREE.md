...
│  │  │  ├─ UpdateOrganizationAction.php
│  │  │  └─ User
│  │  │     ├─ DeleteOrganizationUserAction.php
│  │  │     └─ StoreOrganizationUserAction.php
│  │  ├─ Survey
│  │  │  ├─ CloseSurveyAction.php
│  │  │  ├─ StoreSurveyAction.php
│  │  │  ├─ StoreSurveyAnswerAction.php
...
│  │     │  ├─ UpdateOrganizationRequest.php
│  │     │  └─ User
│  │     │     └─ StoreOrganizationUserRequest.php
│  │     ├─ ProfileUpdateRequest.php
│  │     ├─ Survey
│  │     │  ├─ DeleteSurveyRequest.php
│  │     │  ├─ StoreSurveyAnswerRequest.php
...
│     ├─ dashboard.blade.php
│     ├─ emails
│     │  ├─ daily_survey_report.blade.php
│     │  └─ new_answer_mail.blade.php
│     ├─ layouts
│     │  ├─ addQuestionsSurvey.blade.php
│     │  ├─ AnswerQuestion.blade.php
│     │  ├─ answers_display.blade.php
│     │  ├─ app.blade.php
│     │  ├─ guest.blade.php
│     │  ├─ navigation.blade.php
│     │  └─ questionShow.blade.php
│     ├─ organizations
│     │  ├─ create.blade.php
│     │  ├─ edit.blade.php
│     │  ├─ index.blade.php
